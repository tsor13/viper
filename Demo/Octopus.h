...
inline void get_octopus(std::vector<Vec4> &spheres, std::vector<Vec2i> &pills,
    ...
    std::map<std::string, Vec4> sphere_vals = {
        {"tentacle1.1", 0.250*Vec4(-23.800, -2.450, 1.280, 1.200)},
        {"tentacle1.2", 0.250*Vec4(-23.800, -2.450, -1.150, 1.200)},
        {"tentacle1.3", 0.250*Vec4(-23.800, -4.530, 0.130, 1.200)},
        {"tentacle2.1", 0.250*Vec4(-22.269, -2.374, 1.270, 1.190)},
        {"tentacle2.2", 0.250*Vec4(-22.269, -2.374, -0.909, 1.190)},
        {"tentacle2.3", 0.250*Vec4(-22.269, -4.436, 0.133, 1.190)},
        {"tentacle3.1", 0.250*Vec4(-20.738, -2.299, 1.259, 1.179)},
        {"tentacle3.2", 0.250*Vec4(-20.738, -2.299, -0.668, 1.179)},
        {"tentacle3.3", 0.250*Vec4(-20.738, -4.342, 0.136, 1.179)},
        {"tentacle4.1", 0.250*Vec4(-19.207, -2.223, 1.249, 1.169)},
        {"tentacle4.2", 0.250*Vec4(-19.207, -2.223, -0.427, 1.169)},
        {"tentacle4.3", 0.250*Vec4(-19.207, -4.248, 0.139, 1.169)},
        {"tentacle5.1", 0.250*Vec4(-17.676, -2.148, 1.239, 1.159)},
        {"tentacle5.2", 0.250*Vec4(-17.676, -2.148, -0.186, 1.159)},
        {"tentacle5.3", 0.250*Vec4(-17.676, -4.153, 0.142, 1.159)},
        {"tentacle6.1", 0.250*Vec4(-16.145, -2.072, 1.228, 1.148)},
        {"tentacle6.2", 0.250*Vec4(-16.145, -2.072, 0.055, 1.148)},
        {"tentacle6.3", 0.250*Vec4(-16.145, -4.059, 0.146, 1.148)},
        {"tentacle7.1", 0.250*Vec4(-14.614, -1.997, 1.218, 1.138)},
        {"tentacle7.2", 0.250*Vec4(-14.614, -1.997, 0.296, 1.138)},
        {"tentacle7.3", 0.250*Vec4(-14.614, -3.965, 0.149, 1.138)},
        {"tentacle8.1", 0.250*Vec4(-13.083, -1.921, 1.208, 1.128)},
        {"tentacle8.2", 0.250*Vec4(-13.083, -1.921, 0.537, 1.128)},
        {"tentacle8.3", 0.250*Vec4(-13.083, -3.871, 0.152, 1.128)},
        {"tentacle9.1", 0.250*Vec4(-11.552, -1.846, 1.197, 1.117)},
        {"tentacle9.2", 0.250*Vec4(-11.552, -1.846, 0.778, 1.117)},
        {"tentacle9.3", 0.250*Vec4(-11.552, -3.777, 0.155, 1.117)},
        {"tentacle10.1", 0.250*Vec4(-10.021, -1.770, 1.187, 1.107)},
        {"tentacle10.2", 0.250*Vec4(-10.021, -1.770, 1.019, 1.107)},
        {"tentacle10.3", 0.250*Vec4(-10.021, -3.683, 0.158, 1.107)},
        {"tentacle11.1", 0.250*Vec4(-8.414, -1.695, 1.162, 1.088)},
        {"tentacle11.2", 0.250*Vec4(-8.414, -1.695, 1.109, 1.088)},
        {"tentacle11.3", 0.250*Vec4(-8.414, -3.577, 0.151, 1.088)},
        {"tentacle12.1", 0.250*Vec4(-6.655, -1.621, 1.108, 1.052)},
        {"tentacle12.2", 0.250*Vec4(-6.655, -1.621, 0.896, 1.052)},
        {"tentacle12.3", 0.250*Vec4(-6.655, -3.449, 0.124, 1.052)},
        {"tentacle13.1", 0.250*Vec4(-4.897, -1.546, 1.054, 1.016)},
        {"tentacle13.2", 0.250*Vec4(-4.897, -1.546, 0.683, 1.016)},
        {"tentacle13.3", 0.250*Vec4(-4.897, -3.321, 0.097, 1.016)},
        {"tentacle14.1", 0.250*Vec4(-3.138, -1.472, 1.001, 0.979)},
        {"tentacle14.2", 0.250*Vec4(-3.138, -1.472, 0.470, 0.979)},
        {"tentacle14.3", 0.250*Vec4(-3.138, -3.192, 0.070, 0.979)},
        {"tentacle15.1", 0.250*Vec4(-1.379, -1.397, 0.947, 0.943)},
        {"tentacle15.2", 0.250*Vec4(-1.379, -1.397, 0.257, 0.943)},
        {"tentacle15.3", 0.250*Vec4(-1.379, -3.064, 0.043, 0.943)},
        {"tentacle16.1", 0.250*Vec4(0.379, -1.323, 0.893, 0.907)},
        {"tentacle16.2", 0.250*Vec4(0.379, -1.323, 0.043, 0.907)},
        {"tentacle16.3", 0.250*Vec4(0.379, -2.936, 0.017, 0.907)},
        {"tentacle17.1", 0.250*Vec4(2.138, -1.248, 0.839, 0.871)},
        {"tentacle17.2", 0.250*Vec4(2.138, -1.248, -0.170, 0.871)},
        {"tentacle17.3", 0.250*Vec4(2.138, -2.808, -0.010, 0.871)},
        {"tentacle18.1", 0.250*Vec4(3.897, -1.174, 0.786, 0.834)},
        {"tentacle18.2", 0.250*Vec4(3.897, -1.174, -0.383, 0.834)},
        {"tentacle18.3", 0.250*Vec4(3.897, -2.679, -0.037, 0.834)},
        {"tentacle19.1", 0.250*Vec4(5.655, -1.099, 0.732, 0.798)},
        {"tentacle19.2", 0.250*Vec4(5.655, -1.099, -0.596, 0.798)},
        {"tentacle19.3", 0.250*Vec4(5.655, -2.551, -0.064, 0.798)},
        {"tentacle20.1", 0.250*Vec4(7.414, -1.025, 0.678, 0.762)},
        {"tentacle20.2", 0.250*Vec4(7.414, -1.025, -0.809, 0.762)},
        {"tentacle20.3", 0.250*Vec4(7.414, -2.423, -0.091, 0.762)},
        {"tentacle21.1", 0.250*Vec4(9.103, -0.970, 0.609, 0.712)},
        {"tentacle21.2", 0.250*Vec4(9.103, -0.970, -0.841, 0.712)},
        {"tentacle21.3", 0.250*Vec4(9.103, -2.277, -0.101, 0.712)},
        {"tentacle22.1", 0.250*Vec4(10.759, -0.924, 0.532, 0.655)},
        {"tentacle22.2", 0.250*Vec4(10.759, -0.924, -0.782, 0.655)},
        {"tentacle22.3", 0.250*Vec4(10.759, -2.123, -0.103, 0.655)},
        {"tentacle23.1", 0.250*Vec4(12.414, -0.879, 0.456, 0.598)},
        {"tentacle23.2", 0.250*Vec4(12.414, -0.879, -0.723, 0.598)},
        {"tentacle23.3", 0.250*Vec4(12.414, -1.969, -0.106, 0.598)},
        {"tentacle24.1", 0.250*Vec4(14.069, -0.833, 0.379, 0.541)},
        {"tentacle24.2", 0.250*Vec4(14.069, -0.833, -0.664, 0.541)},
        {"tentacle24.3", 0.250*Vec4(14.069, -1.815, -0.108, 0.541)},
        {"tentacle25.1", 0.250*Vec4(15.724, -0.788, 0.303, 0.484)},
        {"tentacle25.2", 0.250*Vec4(15.724, -0.788, -0.605, 0.484)},
        {"tentacle25.3", 0.250*Vec4(15.724, -1.661, -0.110, 0.484)},
        {"tentacle26.1", 0.250*Vec4(17.379, -0.742, 0.226, 0.428)},
        {"tentacle26.2", 0.250*Vec4(17.379, -0.742, -0.546, 0.428)},
        {"tentacle26.3", 0.250*Vec4(17.379, -1.507, -0.112, 0.428)},
        {"tentacle27.1", 0.250*Vec4(19.034, -0.697, 0.150, 0.371)},
        {"tentacle27.2", 0.250*Vec4(19.034, -0.697, -0.487, 0.371)},
        {"tentacle27.3", 0.250*Vec4(19.034, -1.352, -0.114, 0.371)},
        {"tentacle28.1", 0.250*Vec4(20.690, -0.651, 0.073, 0.314)},
        {"tentacle28.2", 0.250*Vec4(20.690, -0.651, -0.428, 0.314)},
        {"tentacle28.3", 0.250*Vec4(20.690, -1.198, -0.116, 0.314)},
        {"tentacle29.1", 0.250*Vec4(22.345, -0.606, -0.003, 0.257)},
        {"tentacle29.2", 0.250*Vec4(22.345, -0.606, -0.369, 0.257)},
        {"tentacle29.3", 0.250*Vec4(22.345, -1.044, -0.118, 0.257)},
        {"tentacle30.1", 0.250*Vec4(24.000, -0.560, -0.080, 0.200)},
        {"tentacle30.2", 0.250*Vec4(24.000, -0.560, -0.310, 0.200)},
        {"tentacle30.3", 0.250*Vec4(24.000, -0.890, -0.120, 0.200)},
    };
