...
inline void get_octopus(std::vector<Vec4> &spheres, std::vector<Vec2i> &pills,
    ...
    std::map<std::string, Vec4> sphere_vals = {
        {"tentacle1.1", 1.000*Vec4(-2.450, -23.800, 1.280, 1.200)},
        {"tentacle1.2", 1.000*Vec4(-2.450, -23.800, -1.150, 1.200)},
        {"tentacle1.3", 1.000*Vec4(-4.530, -23.800, 0.130, 1.200)},
        {"tentacle2.1", 1.000*Vec4(-2.374, -22.269, 1.270, 1.190)},
        {"tentacle2.2", 1.000*Vec4(-2.374, -22.269, -0.909, 1.190)},
        {"tentacle2.3", 1.000*Vec4(-4.436, -22.269, 0.133, 1.190)},
        {"tentacle3.1", 1.000*Vec4(-2.299, -20.738, 1.259, 1.179)},
        {"tentacle3.2", 1.000*Vec4(-2.299, -20.738, -0.668, 1.179)},
        {"tentacle3.3", 1.000*Vec4(-4.342, -20.738, 0.136, 1.179)},
        {"tentacle4.1", 1.000*Vec4(-2.223, -19.207, 1.249, 1.169)},
        {"tentacle4.2", 1.000*Vec4(-2.223, -19.207, -0.427, 1.169)},
        {"tentacle4.3", 1.000*Vec4(-4.248, -19.207, 0.139, 1.169)},
        {"tentacle5.1", 1.000*Vec4(-2.148, -17.676, 1.239, 1.159)},
        {"tentacle5.2", 1.000*Vec4(-2.148, -17.676, -0.186, 1.159)},
        {"tentacle5.3", 1.000*Vec4(-4.153, -17.676, 0.142, 1.159)},
        {"tentacle6.1", 1.000*Vec4(-2.072, -16.145, 1.228, 1.148)},
        {"tentacle6.2", 1.000*Vec4(-2.072, -16.145, 0.055, 1.148)},
        {"tentacle6.3", 1.000*Vec4(-4.059, -16.145, 0.146, 1.148)},
        {"tentacle7.1", 1.000*Vec4(-1.997, -14.614, 1.218, 1.138)},
        {"tentacle7.2", 1.000*Vec4(-1.997, -14.614, 0.296, 1.138)},
        {"tentacle7.3", 1.000*Vec4(-3.965, -14.614, 0.149, 1.138)},
        {"tentacle8.1", 1.000*Vec4(-1.921, -13.083, 1.208, 1.128)},
        {"tentacle8.2", 1.000*Vec4(-1.921, -13.083, 0.537, 1.128)},
        {"tentacle8.3", 1.000*Vec4(-3.871, -13.083, 0.152, 1.128)},
        {"tentacle9.1", 1.000*Vec4(-1.846, -11.552, 1.197, 1.117)},
        {"tentacle9.2", 1.000*Vec4(-1.846, -11.552, 0.778, 1.117)},
        {"tentacle9.3", 1.000*Vec4(-3.777, -11.552, 0.155, 1.117)},
        {"tentacle10.1", 1.000*Vec4(-1.770, -10.021, 1.187, 1.107)},
        {"tentacle10.2", 1.000*Vec4(-1.770, -10.021, 1.019, 1.107)},
        {"tentacle10.3", 1.000*Vec4(-3.683, -10.021, 0.158, 1.107)},
        {"tentacle11.1", 1.000*Vec4(-1.695, -8.414, 1.162, 1.088)},
        {"tentacle11.2", 1.000*Vec4(-1.695, -8.414, 1.109, 1.088)},
        {"tentacle11.3", 1.000*Vec4(-3.577, -8.414, 0.151, 1.088)},
        {"tentacle12.1", 1.000*Vec4(-1.621, -6.655, 1.108, 1.052)},
        {"tentacle12.2", 1.000*Vec4(-1.621, -6.655, 0.896, 1.052)},
        {"tentacle12.3", 1.000*Vec4(-3.449, -6.655, 0.124, 1.052)},
        {"tentacle13.1", 1.000*Vec4(-1.546, -4.897, 1.054, 1.016)},
        {"tentacle13.2", 1.000*Vec4(-1.546, -4.897, 0.683, 1.016)},
        {"tentacle13.3", 1.000*Vec4(-3.321, -4.897, 0.097, 1.016)},
        {"tentacle14.1", 1.000*Vec4(-1.472, -3.138, 1.001, 0.979)},
        {"tentacle14.2", 1.000*Vec4(-1.472, -3.138, 0.470, 0.979)},
        {"tentacle14.3", 1.000*Vec4(-3.192, -3.138, 0.070, 0.979)},
        {"tentacle15.1", 1.000*Vec4(-1.397, -1.379, 0.947, 0.943)},
        {"tentacle15.2", 1.000*Vec4(-1.397, -1.379, 0.257, 0.943)},
        {"tentacle15.3", 1.000*Vec4(-3.064, -1.379, 0.043, 0.943)},
        {"tentacle16.1", 1.000*Vec4(-1.323, 0.379, 0.893, 0.907)},
        {"tentacle16.2", 1.000*Vec4(-1.323, 0.379, 0.043, 0.907)},
        {"tentacle16.3", 1.000*Vec4(-2.936, 0.379, 0.017, 0.907)},
        {"tentacle17.1", 1.000*Vec4(-1.248, 2.138, 0.839, 0.871)},
        {"tentacle17.2", 1.000*Vec4(-1.248, 2.138, -0.170, 0.871)},
        {"tentacle17.3", 1.000*Vec4(-2.808, 2.138, -0.010, 0.871)},
        {"tentacle18.1", 1.000*Vec4(-1.174, 3.897, 0.786, 0.834)},
        {"tentacle18.2", 1.000*Vec4(-1.174, 3.897, -0.383, 0.834)},
        {"tentacle18.3", 1.000*Vec4(-2.679, 3.897, -0.037, 0.834)},
        {"tentacle19.1", 1.000*Vec4(-1.099, 5.655, 0.732, 0.798)},
        {"tentacle19.2", 1.000*Vec4(-1.099, 5.655, -0.596, 0.798)},
        {"tentacle19.3", 1.000*Vec4(-2.551, 5.655, -0.064, 0.798)},
        {"tentacle20.1", 1.000*Vec4(-1.025, 7.414, 0.678, 0.762)},
        {"tentacle20.2", 1.000*Vec4(-1.025, 7.414, -0.809, 0.762)},
        {"tentacle20.3", 1.000*Vec4(-2.423, 7.414, -0.091, 0.762)},
        {"tentacle21.1", 1.000*Vec4(-0.970, 9.103, 0.609, 0.712)},
        {"tentacle21.2", 1.000*Vec4(-0.970, 9.103, -0.841, 0.712)},
        {"tentacle21.3", 1.000*Vec4(-2.277, 9.103, -0.101, 0.712)},
        {"tentacle22.1", 1.000*Vec4(-0.924, 10.759, 0.532, 0.655)},
        {"tentacle22.2", 1.000*Vec4(-0.924, 10.759, -0.782, 0.655)},
        {"tentacle22.3", 1.000*Vec4(-2.123, 10.759, -0.103, 0.655)},
        {"tentacle23.1", 1.000*Vec4(-0.879, 12.414, 0.456, 0.598)},
        {"tentacle23.2", 1.000*Vec4(-0.879, 12.414, -0.723, 0.598)},
        {"tentacle23.3", 1.000*Vec4(-1.969, 12.414, -0.106, 0.598)},
        {"tentacle24.1", 1.000*Vec4(-0.833, 14.069, 0.379, 0.541)},
        {"tentacle24.2", 1.000*Vec4(-0.833, 14.069, -0.664, 0.541)},
        {"tentacle24.3", 1.000*Vec4(-1.815, 14.069, -0.108, 0.541)},
        {"tentacle25.1", 1.000*Vec4(-0.788, 15.724, 0.303, 0.484)},
        {"tentacle25.2", 1.000*Vec4(-0.788, 15.724, -0.605, 0.484)},
        {"tentacle25.3", 1.000*Vec4(-1.661, 15.724, -0.110, 0.484)},
        {"tentacle26.1", 1.000*Vec4(-0.742, 17.379, 0.226, 0.428)},
        {"tentacle26.2", 1.000*Vec4(-0.742, 17.379, -0.546, 0.428)},
        {"tentacle26.3", 1.000*Vec4(-1.507, 17.379, -0.112, 0.428)},
        {"tentacle27.1", 1.000*Vec4(-0.697, 19.034, 0.150, 0.371)},
        {"tentacle27.2", 1.000*Vec4(-0.697, 19.034, -0.487, 0.371)},
        {"tentacle27.3", 1.000*Vec4(-1.352, 19.034, -0.114, 0.371)},
        {"tentacle28.1", 1.000*Vec4(-0.651, 20.690, 0.073, 0.314)},
        {"tentacle28.2", 1.000*Vec4(-0.651, 20.690, -0.428, 0.314)},
        {"tentacle28.3", 1.000*Vec4(-1.198, 20.690, -0.116, 0.314)},
        {"tentacle29.1", 1.000*Vec4(-0.606, 22.345, -0.003, 0.257)},
        {"tentacle29.2", 1.000*Vec4(-0.606, 22.345, -0.369, 0.257)},
        {"tentacle29.3", 1.000*Vec4(-1.044, 22.345, -0.118, 0.257)},
        {"tentacle30.1", 1.000*Vec4(-0.560, 24.000, -0.080, 0.200)},
        {"tentacle30.2", 1.000*Vec4(-0.560, 24.000, -0.310, 0.200)},
        {"tentacle30.3", 1.000*Vec4(-0.890, 24.000, -0.120, 0.200)},
